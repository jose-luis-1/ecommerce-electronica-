...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "Audífonos",
    image_url:
      "https://images.unsplash.com/photo-1629367494173-c78a56567877?w=400&h=400&fit=crop",
    stock: 15,
    created_at: new Date().toISOString(),
  },
  {
                ...
                >
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-800 space-y-3">
                      <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 block">
                        ${new Intl.NumberFormat("es-CO").format(product.price)}
                      </span>
                      <button className="w-full py-2.5 rounded-lg bg-white text-slate-950 text-sm font-bold hover:bg-slate-200 transition-colors">
                        Ver Detalles
                      </button>
                    </div>
                  </div>
