        ...
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="text-2xl font-bold text-white tracking-tight">
              Tech<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Store</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {/* Carrito */}
            <Link to="/cart" className="relative group p-2 rounded-full hover:bg-slate-800 transition-colors">
            ...
            <div className="border-t border-slate-800 my-4 pt-4">
              {user ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Link to="/login" className="flex justify-center items-center py-3 rounded-xl border border-slate-700 text-slate-300 font-medium hover:bg-slate-800">
                    Ingresar
                  </Link>
                  <Link to="/register" className="flex justify-center items-center py-3 rounded-xl bg-purple-600 text-white font-bold hover:bg-purple-700">
                    Registrarse
                  </Link>
                </div>
              )}
...
const NavLink = ({ to, children, current, className, ...rest }: NavLinkProps) => (
  <Link
    to={to}
  ...
  >
    ...
    <span className={`absolute -bottom-6 left-0 w-full h-0.5 bg-purple-500 rounded-t-full transition-all duration-300 ${
...
const MobileNavLink = ({ to, children, icon: Icon, className, ...rest }: MobileNavLinkProps) => (
  <Link
    to={to}
