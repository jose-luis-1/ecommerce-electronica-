            ...
            <div className="flex-1 max-w-md">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 pl-10 pr-10 bg-slate-900 border border-slate-700 rounded-lg text-sm text-white placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                />
                <svg
