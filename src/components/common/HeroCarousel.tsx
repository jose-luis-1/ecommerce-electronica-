        ...
        <div className="relative bg-gradient-to-br from-slate-900 via-slate-900 to-slate-900/50 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl h-auto sm:h-96">
          ...
          <div className="relative flex flex-col sm:flex-row gap-6 p-4 sm:p-6 h-full">
            ...
            <div className="flex items-center justify-center w-full sm:w-1/2">
              <Link to={`/products?discount=true&featured=${currentProduct.id}`} className="relative w-full h-full rounded-xl overflow-hidden bg-slate-800 group object-cover cursor-pointer">
                <img
